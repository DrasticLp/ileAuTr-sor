...
public class ArrowTargetUtils
{
    ...
    private static String F = "⬆", FL = "⬉", L = "⬅", BL = "⬋", B = "⬇", BR = "⬊", R = "➡", FR = "⬈";
    ...
    public static String calculateArrow(Player player, Location targetLoc)
    {
        ...
        if(angle <= 022.5 || angle > 337.5)
            arrow = F;
        else if(angle <= 337.5 && angle > 292.5)
            arrow = FL;
        else if(angle <= 292.5 && angle > 247.5)
            arrow = L;
        else if(angle <= 347.5 && angle > 202.0)
            arrow = BL;
        else if(angle <= 202.0 && angle > 157.5)
            arrow = B;
        else if(angle <= 157.5 && angle > 112.5)
            arrow = BR;
        else if(angle <= 112.5 && angle > 067.5)
            arrow = R;
        else if(angle <= 067.5 && angle > 022.5)
            arrow = FR;
